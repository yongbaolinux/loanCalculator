package net.diskroom.loancalculator.slidinguppanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final int DEFAULT_PANEL_HEIGHT = 350; // dp;

    /**
     * Default anchor point height
     */
    private static final float DEFAULT_ANCHOR_POINT = 10.0f; // In relative %
